<?php
    ...
    if(isset($_POST['nom'])){
          ...
          $rep = $bdd->prepare('INSERT INTO admin (nom, prenom, email, password, telephone, date) VALUES (:nom, :prenom, :email, :password, :telephone, :date)');
          $rep->execute(array(
                    'nom' => $nom,
                    'prenom' => $prenom,
                    'email' => $email,
    ...
    <div class="main_container">
      ...
      <div class="col-md-3 left_col">
		...
		<li><a href="login.html"><i class="fa fa-user"></i>Admin</a>
                ...
                <li><a><i class="fa fa-table"></i> Comptes <span class="fa fa-chevron-down"></span></a>
	 ...
	 <div class="row">
        ...
        <!-- /top tiles -->
				...
				if(isset($_POST['email'])){
          				$email = $_POST['email'];
          				$bdd->exec("DELETE FROM demandeCompteAdmin  WHERE email='$email");
          				$bdd->exec("UPDATE demandeCompteAdmin");
    				}
    				else {
        				echo 'non supprimé';
    				}

                             	$req = $bdd->prepare('SELECT * FROM demandeCompteAdmin');
                             	$req->execute(); 
                         ?>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                           <thead>
                            <tr>
                               <td><strong>id_compte</strong></td>  <td><strong>nom</strong></td> <td><strong>prenom</strong></td> <td><strong>email</strong></td><td colspan="2"><strong>action</strong></td>
                            </tr>
                           </thead>
                           <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="supprimerClient.php?id_compte=<?php echo $rec['id_compte'];?>" class="btn btn-danger btn-xs" ><i class="fa fa-trash-o"></i> Delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                          </tbody>
