        ...
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Modifier Administrateur <small> Admin</small></h2>
                  <div class="clearfix"></div>
                </div>
            ...
            <!--div class="col-md-6 col-sm-12 col-xs-12">
			 ...
			 <?php
				...
				require_once 'db_connect.php';
        	       	 	$query  = "SELECT * FROM administrateur where id_administrateur='".$id_admin."' ";
	        	        $result = mysqli_query($conn,$query);
                		if(mysqli_num_rows($result)){
					while ($client = mysqli_fetch_object($result)){
                        ?>
				<form class="form-horizontal form-label-left"  method="post" action="listermodifier_admin.php?id=<?php echo $id_admin; ?>">
                  	  <div class="form-group">
                  	    <label class="control-label col-md-3 col-sm-3 col-xs-3">Id Admin:</label>
                  	    <div class="col-md-9 col-sm-9 col-xs-9">
			    <input type="text" readonly class="form-control" data-inputmask="'mask': '99/99/9999'" name="id_admin" value="<?php echo $id_admin;?>" >
