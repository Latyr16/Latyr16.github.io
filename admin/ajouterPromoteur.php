          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_content">
                  <br/>
                  <form  enctype="multipart/form-data" class="form-horizontal form-label-left"  method="post" action="insert_promoteur.php?id=66">
			<div class="form-group">
                      			<label for="imageUpload1" class="control-label col-md-3 col-sm-3 col-xs-3">Choisir votre fichier CSV des Promoteurs</label>
