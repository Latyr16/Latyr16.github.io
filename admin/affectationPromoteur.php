...
?>
      ...
      <div class="right_col" role="main">
        ...
        <?php
                ...
                $query  = "SELECT * FROM promoteurbis ";
		...
		<table id="datatable-buttons" class="table table-striped table-bordered">
			...
			<?php while ($client = mysqli_fetch_object($result)){
                                ...
                                <tr>
                                    ...
                                    <td align="center">
				    <a href="affecter_promoteur.php?id_promoteur=<?php echo $client->id_promoteur;?>&id_superviseur=<?php echo $_GET['id_superviseur'];?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>Affecter</a>
				    </td>
                                </tr>
                                <?php } ?>
