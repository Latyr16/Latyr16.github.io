	 ...
	 <div class="row">
        ...
        <!-- /top tiles -->
			 <?php
                             ...
                             $id=$_GET['id_compte'];
                                echo $id;
                             $bdd->exec("DELETE FROM demandeCompteClient WHERE id_compte='$id'");
                             $re=$bdd->exec("UPDATE demandeCompteClient");
                             $re->execute();
                             $req = $bdd->prepare('SELECT * FROM demandeCompteClient');
                             $req->execute();

                             $db = new PDO('mysql:host=localhost;dbname=ec2lt','root','passer');
                             $req = $db->prepare('SELECT * FROM demandeCompteAdmin');
                             $req->execute();
                         ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <a href="modifierClient.php?code=<?php echo $rec['id_compte'];?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>Edit</a>
                                    </td>
                                    <td>
                                        <a href="supprimerClient.php?code=<?php echo $rec['id_compte'];?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>Delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
