        ...
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Liste des Superviseurs à attribuer des Promoteurs <small> Admin</small></h2>
                  <div class="clearfix"></div>
                </div>
		...
		<table id="datatable-buttons" class="table table-striped table-bordered">
			...
			<?php while ($client = mysqli_fetch_object($result)){
                                ...
                                <tr>
                                    ...
                                    <td align="center">
					<a href="affectationPromoteur.php?id_superviseur=<?php echo $client->id_superviseur;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>Attribuer promoteur</a>
				    </td>
                                </tr>
                                <?php } ?>
