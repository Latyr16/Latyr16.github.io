  ...
  <div class="container body">
    ...
    <div class="main_container">
	 ...
	 <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
			 ...
			 <?php 
			     $id=$_GET['id_compte'];
                             ...
                             $req = $db->prepare("SELECT * FROM demandeCompteAdmin WHERE id_compte= '$id'");
                             $req->execute();
                         ?>
			   <table id="datatable-buttons" class="table table-striped table-bordered">
				     ...
				     <td>
                                        <a href="modifierAdmin.php?id_compte=<?php echo $rec['id_compte'];?>" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i>Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>
                          </tbody>
		...
		<div class="x_content">
                <form class="form-horizontal form-label-left"  method="post" action="Admin.php">
