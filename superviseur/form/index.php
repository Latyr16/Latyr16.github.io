<?php
	...
	$id_agent = $_SESSION['id_agent'];
        $id_supervisuer = $_SESSION['id_superviseur'];
...
<body>
	<!-- Entête -->
	  ...
	  <div class="forms-box">
		<div align="center">
	  		<div class="col-12 col-lg-4 news_6">
			<form   enctype="multipart/form-data" method="post" action="../insert_client.php?id_agent=<?php echo $id_agent;?>&id_promoteur=<?php echo $id_promoteur ;?>" name="formulaire" onsubmit="return valider ();">
	  				...
	  				<div class="form-content">
						...
						<div class="form-row">
							...
							<div class="col">
                                                                <label>Numéro Identification carte </label>
                                                                <input type="text" name="identification_carte" class="form-control" placeholder="identification carte">
                                                        </div>
                                                </div>
		  				<div class="form-row">
                                                        <div class="col">
								<label for="imageUpload1" class="btn-primary btn-block btn-outlined">Photo carte CNI recto</label>
								<input type="file" id="imageUpload1" name="photo_recto" accept="image/*" capture="camera" style="display: none">
                                                	</div>
                                                        <div class="col">
								<label for="imageUpload2" class="btn-primary btn-block btn-outlined">Photo carte CNI verso</label>
								<input type="file" id="imageUpload2" name="photo_verso" accept="image/*" capture="camera" style="display: none">
                                                	</div>
                                                </div>
		  				<div class="form-row">
		  					<div class="col">
