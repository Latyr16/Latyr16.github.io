...
?>
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Liste des Clients qui sont validés l'année <small> </small></h2>
                  <div class="clearfix"></div>
                </div>
		...
		$annee = date("Y")-1; 
                $query  = "SELECT * FROM client_valider where id_superviseur='".$id_superviseur."' and annee='".$annee."' ";
		...
		<table id="datatable-buttons" class="table table-striped table-bordered">
         ...
         <?php }
                        ...
                        echo "  <script type=\"text/javascript\">alert(\"Vous n'etes pas encore en fin d'année\");
